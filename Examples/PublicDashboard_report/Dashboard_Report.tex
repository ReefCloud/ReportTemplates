...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, boxrule=0pt, frame hidden, breakable, colback={codebgcolor}, enhanced]}{\end{tcolorbox}}\fi
\makeatother
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/Region_Map.png}}\hfill
\end{minipage}%
%
\begin{minipage}{0.40\linewidth}

\section{Region: Brunei}\label{region-brunei}

\textbf{Country} Brunei \textbf{Report Year}: 2024\end{minipage}%

\end{figure}%

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Disclaimer}, rightrule=.15mm, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, left=2mm, opacityback=0, breakable, colback=white, colframe=quarto-callout-note-color-frame]
...
Brunei in Brunei, encompasses the following details:

\begin{itemize}
\tightlist
\item
  \textbf{Number of Sites}: 13
\item
  \textbf{Number of Photo Quadrats}: 7036
\item
  \textbf{Data Contributors}: Brunei Department of Fisheries
\item
  \textbf{Source}: www.reefcloud.ai
\item
  \textbf{Report Year}: 2024
\end{itemize}
...
Brunei}\label{status-of-coral-reef-habitats-in-brunei}
...
\tightlist
\item
  In 2024, 56\% of a total of 13 monitored reef sites exhibited Hard
  Coral within 10 - 30 \% (Figure~\ref{fig-waffle})
\end{enumerate}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/temporal_HardCoral_cover.png}
...
\tightlist
\item
  by 2024, the Hard Coral cover in Brunei was estimated to be 21 \%,
  varying across the region between 14 and 31.
\item
  Compared to the earliest monitoring record for this region in
  ReefCloud, hard coral cover has changed from 18 in 2023 to 21 in 2024.
\item
  Over the reported period (2023 to 2024), XX severe environmental
  disturbances affected the region. XX Tropical Cyclones and XX Marine
  Heatwaves impacted coral reefs in Brunei.
\end{enumerate}
...
\bottomrule\noalign{}
\endlastfoot
Pelong West & 115.0514 & 5.083560 & 730 \\
Two Fathom Rock SouthWest & 114.9697 & 5.096930 & 672 \\
Two Fathom Rock North & 114.9693 & 5.097370 & 704 \\
Two Fathom Rock SouthEast & 114.9691 & 5.096180 & 649 \\
Abana Reef South & 115.0705 & 5.107650 & 509 \\
Pelong East & 115.0541 & 5.082790 & 1092 \\
Brunei Patches & 114.6978 & 5.008200 & 499 \\
Amcotts Rock & 114.6261 & 5.042778 & 338 \\
Abana area & 115.0706 & 5.107940 & 440 \\
Pelong Rock & 115.0516 & 5.079390 & 634 \\
Pelong East & 115.0516 & 5.083530 & 244 \\
Abana 1 & 115.0400 & 5.060000 & 370 \\
West Coral Nursery (PELONG) & 115.0662 & 5.071120 & 155 \\
