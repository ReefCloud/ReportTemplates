...
#' @param e_type Character. Type of environmental disturbance to retrieve. Options: "thermal_stress", "storm_exposure_year".
#'
...
#' @examples
#' # Example usage:
#' disturbances <- get_disturbance_ext("your_tier_id", "thermal_stress")
#' head(disturbances)
